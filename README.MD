...
protoc  \
  --proto_path=${GOPATH}/src \
  --proto_path=${GOPATH}/src/github.com/gogo/protobuf@v1.3.2/protobuf \
  --proto_path=. \
  --gogo_out=. \
...
protoc \
	...
	--proto_path=. \
	--gogo_out=Mgoogle/protobuf/descriptor.proto=github.com/gogo/protobuf@v1.3.2/protoc-gen-gogo/descriptor:. \
	validator.proto